...
java -cp . -Djava.rmi.server.codebase=file:/home/marcugas/Desktop/Java_RMI-main/Ejemplos/Ejemplo2/ -Djava.rmi.server.hostname=localhost -Djava.security.policy=server.policy Ejemplo &
